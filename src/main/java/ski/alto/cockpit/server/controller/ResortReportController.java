...
public class ResortReportController {
    ...
    @CrossOrigin(origins = {"http://94.127.4.240:4200", "http://localhost:8081", "https://cockpit.alto.ski", "http://65.21.206.110:8081"}, methods = {RequestMethod.POST, RequestMethod.OPTIONS})
